...
export class InitalMigration1764096736192 implements MigrationInterface {
    name = 'InitalMigration1764096736192'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "proficiency_levels" ("id" SERIAL NOT NULL, "code" character varying(10) NOT NULL, "name" character varying(100) NOT NULL, "display_order" integer NOT NULL DEFAULT '0', "is_active" boolean NOT NULL DEFAULT true, "subject_id" integer NOT NULL, "ai_configuration" jsonb NOT NULL, "recommended_ai" character varying(100) NOT NULL, "recommended_model" character varying(100) NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_cea56d60c4a616522f60ee62ea2" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "topics" ("id" SERIAL NOT NULL, "name" character varying(255) NOT NULL, "description" text, "display_order" integer NOT NULL DEFAULT '0', "subject_id" integer NOT NULL, "skill_category_id" integer NOT NULL, "proficiency_level_id" integer NOT NULL, "is_active" boolean NOT NULL DEFAULT true, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_e4aa99a3fa60ec3a37d1fc4e853" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_76846a419a7579eb3cef3730b9" ON "topics" ("is_active") `);
        await queryRunner.query(`CREATE INDEX "IDX_1304b1c61016e63f60cd147ce6" ON "topics" ("name") `);
        await queryRunner.query(`CREATE INDEX "IDX_0f031480737c34ab28f26bc438" ON "topics" ("skill_category_id") `);
        await queryRunner.query(`CREATE INDEX "IDX_5259f63d1456968c2607430ece" ON "topics" ("subject_id", "skill_category_id") `);
        await queryRunner.query(`CREATE INDEX "IDX_002c0d43b06fcd693cd4b3da5c" ON "topics" ("subject_id") `);
        ...
        await queryRunner.query(`ALTER TABLE "topics" ADD CONSTRAINT "FK_0f031480737c34ab28f26bc438f" FOREIGN KEY ("skill_category_id") REFERENCES "skill_categories"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "topics" ADD CONSTRAINT "FK_56f55fa209ae362022f69ab2213" FOREIGN KEY ("proficiency_level_id") REFERENCES "proficiency_levels"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "topics" DROP CONSTRAINT "FK_56f55fa209ae362022f69ab2213"`);
        await queryRunner.query(`ALTER TABLE "topics" DROP CONSTRAINT "FK_0f031480737c34ab28f26bc438f"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_002c0d43b06fcd693cd4b3da5c"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_5259f63d1456968c2607430ece"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_0f031480737c34ab28f26bc438"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_1304b1c61016e63f60cd147ce6"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_76846a419a7579eb3cef3730b9"`);
